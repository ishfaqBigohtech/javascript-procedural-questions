...
export class ICruze extends solarInverter {
  product: string = "ICruze";
  hasBattery: boolean = true;
  haveGrid: boolean = false;
  haveSolarPanel: boolean = false;
  ...
  checkInverter() {
    return this.solarInverterProperties(
      this.product,
      this.haveSolarPanel,
      this.hasBattery,
      this.haveGrid
